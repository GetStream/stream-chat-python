...
**Step 3b: Prepare Import File.** The [import section](/chat/docs/python/import/) has the full details. First practice with a small import.
...
**Step 4: Final Import.** Next, [Import](/chat/docs/python/import/) all historical data.
...
2. Export chat data in Stream's [import format](/chat/docs/python/import/)
...
2. Review the [Importing Data](/chat/docs/python/import/) guide
