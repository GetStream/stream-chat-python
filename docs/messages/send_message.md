...
```python
message = {"text": "Check this out https://imgur.com/r/bears/4zmGbMN"}
channel.send_message(message, user_id)
```
...
> [!WARNING]
> Deleting a message does not delete its file attachments. See [deleting attachments](/chat/docs/python/file_uploads/#deleting-files-and-images/) for more information.
