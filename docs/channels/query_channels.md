...
> [!NOTE]
> For supported query operators, see [Query Syntax Operators](/chat/docs/python/query_syntax_operators/).
...
For the full list of supported query operators, see [Query Syntax Operators](/chat/docs/python/query_syntax_operators/).
...
channels = client.query_channels(
    {"type": "messaging", "members": {"$in": [user_id]}},
    {"last_message_at": -1},
    limit=20,
)
```
