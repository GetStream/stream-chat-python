...
For loading many channels at once, use [client.queryChannels()](/chat/docs/python/query_channels/)—this fetches and watches multiple channels in a single call, reducing API traffic.
