...
- **grants** : Allows to modify channel-type permission grants for particular channel. More information can be found [here](/chat/docs/python/chat_permission_policies/)
...
- **shared_locations** : Allow users to share their current location. More information can be found [here](/chat/docs/python/location_sharing/)
