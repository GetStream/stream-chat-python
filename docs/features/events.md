...
Users connected to a channel, either as a watcher or member, can send custom events and have them delivered to all users [watching the channel](/chat/docs/python/creating_channels/).
...
Like every client-side API request, sending a custom event includes a permission check. By default users that can read messages on a channel can also send custom events. Check the [Auth & Permission](/chat/docs/python/chat_permission_policies/) section to find out more about how permissions can be customized for your application.
...
| message            | object | [Message Object](/chat/docs/python/send_message/#message-response-structure) |         | ✓        |
| reaction           | object | [Reaction Object](/chat/docs/python/send_reaction/)                          |         | ✓        |
| channel            | object | [Channel Object](/chat/docs/python/creating_channels/)                       |         | ✓        |
