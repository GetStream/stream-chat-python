In addition to [rate limits](/chat/docs/python/rate_limits/), Stream enforces **API budgets** on expensive
...
API budgets and [rate limits](/chat/docs/python/rate_limits/) work together but measure different things:
