...
> [!NOTE]
> You can use a `{type}` variable substitution in the URL to pass on the name of the command that was triggered. See [Webhooks Overview](/chat/docs/python/webhooks_overview/) for more information on URL configuration
...
> [!NOTE]
> You can find more information on message rewrite in [Before Message Send Webhook](/chat/docs/python/before_message_send_webhook/) page
