...
> [!NOTE]
> For reliable event delivery, you can also configure [SQS](/chat/docs/python/sqs/) or [SNS](/chat/docs/python/sns/) instead of webhooks.
...
| [Before Message Send](/chat/docs/python/before_message_send_webhook/) | Allows you to modify or moderate message content before sending it to the chat for everyone to see |
| [Custom Commands](/chat/docs/python/custom_commands_webhook/)         | Reacts to custom /slash commands                                                                   |
...
For more information on configuring pending messages, please refer to the [Pending Messages](/chat/docs/python/pending_messages/) documentation.
