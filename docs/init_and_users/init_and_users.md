...
| userToken | string/function | The Token Provider function or authentication token. See [Tokens & Authentication](/chat/docs/python/tokens_and_authentication/) for details                                                                                    | default |          |
